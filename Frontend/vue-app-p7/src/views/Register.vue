<template>
    <div class="register">        
        <!--<header>
            ...
            <img src="..\logos\icon-above-font2.png" alt ="logo Groupomania">
        </header>-->
        <HeaderFirst />
        ...
        <div class="formulaire">
            <form>
                <!--<fieldset>
                    ...
                    <label for="username">Nom d'utilisateur :</label><input type="text" name="username" v-model="username" required /><br><p id="usernamePasConforme"></p><br>
                    ...
                    <input type="submit" class="button" @click.prevent="registerUser" value="S'inscrire">
                <!--</fieldset>-->
            </form>
        </div>
    </div>
